...
function consultar_todo(){
    $.ajax({ 
        url:"https://ged713c8480dabf-mdb01.adb.ca-toronto-1.oraclecloudapps.com/ords/admin/moto/moto",
        type:"GET",
        datatype:"json",
        ...
        success:function(json){
           	$("#resultado").empty();
			tabla = "<center> <table border='1'> <tr> <th>ID</th> <th>BRAND</th> <th>MODEL</th> <th>CATEGORY ID</th><th>NAME</th></tr> </tr>"
...
function consultaID(id){
	...
	if(!validarCampo($("#id"))){
		...
		$.ajax({
			url: 'https://ged713c8480dabf-mdb01.adb.ca-toronto-1.oraclecloudapps.com/ords/admin/moto/moto'+ id.val(),			
			type: 'GET',
			dataType: 'json',
